...
export class StationBase implements Geolocation {
    public id: string;
    public type: 'platform' | 'lightning' | 'webcam' | 'lidar' | 'wms';
    public lat: number;
    public lng: number;
    ...
    constructor(
        ...
        city?: string,
        alt?: number,
        type: 'platform' | 'lightning' | 'webcam' | 'lidar' | 'wms' = 'platform',
    ...
    static createFromGeoJSONProps(props: Record<string, any>): StationBase {     
        ...
        if ('type' in props && typeof props['type'] === 'string' && (props['type'] === 'platform' || props['type'] === 'lightning' || props['type'] === 'webcam' || props['type'] === 'lidar')) station.type = props['type'];
